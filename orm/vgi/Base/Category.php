...
abstract class Category implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\vgi\\Map\\CategoryTableMap';
    ...
    /**
     * Initializes internal state of vgi\Base\Category object.
     */
     ...
     * @return $this|\vgi\Category The current object (for fluent API support)
     */
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[CategoryTableMap::COL_TEXT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CategoryTableMap::translateFieldName('Text', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\vgi\\Category'), 0, $e);
        }
    }
        ...
        $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                if ($this->archiveOnDelete) {
                    // do nothing yet. The object will be archived later when calling ChildCategoryQuery::delete().
                } else {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CategoryTableMap::COL_TEXT)) {
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\vgi\Category The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CategoryTableMap::COL_TEXT)) {
            $criteria->add(CategoryTableMap::COL_TEXT, $this->text);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \vgi\Category (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \vgi\Category Clone of current object.
     * @throws PropelException
     */
     ...
     * @param ConnectionInterface $con Optional connection object
     *
     * @return     ChildCategoryArchive An archive object, or null if the current object was never archived
     */
    public function getArchive(ConnectionInterface $con = null)
    {
        ...
        $archive = ChildCategoryArchiveQuery::create()
            ->filterByPrimaryKey($this->getPrimaryKey())
            ->findOne($con);
     ...
     *
     * @return     ChildCategoryArchive The archive object based on this object
     */
    public function archive(ConnectionInterface $con = null)
    {
        ...
        if (!$archive) {
            $archive = new ChildCategoryArchive();
     ...
     *
     * @param      ChildCategoryArchive $archive An archived object based on the same class
      *
