...
abstract class State implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\vgi\\Map\\StateTableMap';
    ...
    /**
     * Initializes internal state of vgi\Base\State object.
     */
     ...
     * @return $this|\vgi\State The current object (for fluent API support)
     */
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[StateTableMap::COL_TEXT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : StateTableMap::translateFieldName('Text', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 1; // 1 = StateTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\vgi\\State'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(StateTableMap::COL_TEXT)) {
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\vgi\State The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StateTableMap::COL_TEXT)) {
            $criteria->add(StateTableMap::COL_TEXT, $this->text);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \vgi\State (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \vgi\State Clone of current object.
     * @throws PropelException
     */
     ...
     * @param ConnectionInterface $con Optional connection object
     *
     * @return     ChildStateArchive An archive object, or null if the current object was never archived
     */
    public function getArchive(ConnectionInterface $con = null)
    {
        ...
        $archive = ChildStateArchiveQuery::create()
            ->filterByPrimaryKey($this->getPrimaryKey())
            ->findOne($con);
     ...
     *
     * @return     ChildStateArchive The archive object based on this object
     */
     ...
     *
     * @param      ChildStateArchive $archive An archived object based on the same class
      *
