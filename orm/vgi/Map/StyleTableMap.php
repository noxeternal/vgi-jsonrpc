...
class StyleTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'vgi.Map.StyleTableMap';
     ...
     */
    const OM_CLASS = '\\vgi\\Style';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'vgi.Style';
     ...
     */
    const COL_NAME = 'style.name';

    /**
     * the column name for the text field
     */
    const COL_TEXT = 'style.text';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Name', 'Text', ),
        self::TYPE_CAMELNAME     => array('name', 'text', ),
        self::TYPE_COLNAME       => array(StyleTableMap::COL_NAME, StyleTableMap::COL_TEXT, ),
        self::TYPE_FIELDNAME     => array('name', 'text', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Name' => 0, 'Text' => 1, ),
        self::TYPE_CAMELNAME     => array('name' => 0, 'text' => 1, ),
        self::TYPE_COLNAME       => array(StyleTableMap::COL_NAME => 0, StyleTableMap::COL_TEXT => 1, ),
        self::TYPE_FIELDNAME     => array('name' => 0, 'text' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(StyleTableMap::COL_NAME);
            $criteria->addSelectColumn(StyleTableMap::COL_TEXT);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \vgi\Style) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(StyleTableMap::DATABASE_NAME);
            $criteria->add(StyleTableMap::COL_NAME, (array) $values, Criteria::IN);
        }
