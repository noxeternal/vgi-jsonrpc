...
class StateTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'vgi.Map.StateTableMap';
     ...
     */
    const OM_CLASS = '\\vgi\\State';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'vgi.State';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(StateTableMap::COL_TEXT, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(StateTableMap::COL_TEXT => 0, ),
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(StateTableMap::COL_TEXT);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \vgi\State) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(StateTableMap::DATABASE_NAME);
            $criteria->add(StateTableMap::COL_TEXT, (array) $values, Criteria::IN);
        }
